...
def user_statistics(request):
    ...
    stats = {
        ...
        'success': MailingAttempt.objects.filter(mailing__in=mailings, status='success').count(),
        'failed': MailingAttempt.objects.filter(mailing__in=mailings, status='failed').count()
    }
...
def detailed_stats(request, mailing_id):
    ...
    return render(request, 'mailing/detailed_stats.html', {
        'mailing': mailing,
        'attempts': attempts,
        'stats': stats
    })